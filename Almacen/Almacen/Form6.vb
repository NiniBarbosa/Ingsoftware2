...
Public Class Form6
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If (salir = DialogResult.Yes) Then
            Me.Close()
        End If
        Form2.IngresoToolStripMenuItem.Enabled = True
    End Sub
            ...
            If TextBox2.Text <> "" Then
                If TextBox3.Text <> "" Then
                    If ComboBox1.Text <> "" Then
                        ...
                        SQLSelect = "INSERT INTO salida_mercancia (id,idproducto,fecha_salida,talla,cantidad,descripcion)  VALUES(" + vId.ToString() + "," + id_prd.ToString() + ",Date('now'),'" + ComboBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "');"
                        Dim connection As String = "Data Source=Almacen.db;Version=3;New=False;Compress=True;"
                        ...
                        SQLConn.Close()
                        MessageBox.Show("Salida de mercancia correctamente")
                        TextBox1.Text = ""
                        TextBox2.Text = ""
                        TextBox3.Text = ""
                        TextBox1.Enabled = False
